    ...
    <div className='flex flex-col items-center justify-center min-w-96 mx-auto'>
        <div className='w-full p-6 rounded-lg shadow-md bg-gray-400 bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-0 border'>
            ...
            <label className="input input-bordered flex items-center gap-2 mt-4">
                ...
                <a className="link link-primary justify-start font-light" href="/signup">Don't have an account?</a>


                <div>
                    <button className="btn btn-wide mt-4 border-white text-white">Log In</button>
                </div>
            </form>
        </div>
    </div>
